...
def init(request):
    ...
    :return:
    '''
    player_id=request.user.id-1
    position_list = []
    for i in range(1, 6):
        position_x = initialization.get_player_attribute(i, 'position_x')
        position_y = initialization.get_player_attribute(i, 'position_y')
